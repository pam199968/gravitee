job "gravitee-apim-gateway" {
    ...
    group "apim-gateway" {
	    ...
	    artifact {
	    	source = "http://repo.proxy-dev-forge.asip.hst.fluxus.net/artifactory/asip-snapshots/fr/ans/psc/digitalsign-gravitee-resource/1.2-SNAPSHOT/digitalsign-gravitee-resource-1.2-SNAPSHOT.zip"
		options {
			archive = false
		}
	    }
	    artifact {
	    	source = "http://repo.proxy-dev-forge.asip.hst.fluxus.net/artifactory/asip-snapshots/fr/ans/psc/digitalsign-gravitee-policy/1.2-SNAPSHOT/digitalsign-gravitee-policy-1.2-SNAPSHOT.zip"
		options {
			archive = false
		}
	    }
	    artifact {
	    	source = "http://repo.proxy-dev-forge.asip.hst.fluxus.net/artifactory/asip-snapshots/fr/ans/psc/digital-sign-resource-api/1.2-SNAPSHOT/digital-sign-resource-api-1.2-SNAPSHOT.jar"
		options {
			archive = false
		}
	    }
		...
		mount {
			type = "bind"
			target = "/opt/graviteeio-gateway/plugins/digitalsign-gravitee-resource-1.2-SNAPSHOT.zip"
			source = "local/digitalsign-gravitee-resource-1.2-SNAPSHOT.zip"
			readonly = false
			bind_options {
				propagation = "rshared"
				}
		...
		mount {
			type = "bind"
			target = "/opt/graviteeio-gateway/plugins/digitalsign-gravitee-policy-1.2-SNAPSHOT.zip"
			source = "local/digitalsign-gravitee-policy-1.2-SNAPSHOT.zip"
			readonly = false
			bind_options {
				propagation = "rshared"
				}
		...
		mount {
			type = "bind"
			target = "/opt/graviteeio-gateway/lib/digital-sign-resource-api-1.2-SNAPSHOT.jar"
			source = "local/digital-sign-resource-api-1.2-SNAPSHOT.jar"
			readonly = false
			bind_options {
				propagation = "rshared"
				}
